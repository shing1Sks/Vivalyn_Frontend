import { BarChart2, CreditCard, LayoutDashboard, LogOut, MessageSquare, Tag } from 'lucide-react'

export type AdminSection = 'home' | 'analytics' | 'inquiries' | 'subscriptions' | 'discounts'
